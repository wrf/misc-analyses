...
Occurrence of samples from each kingdom, phylum and class in public databases. This is also integrated into an [interactive ShinyApp map](https://rstudio.github.io/leaflet/).
