...
# score cutoffs
cutoffs = c(91.2, 92.4, 87, 92.8, 89.4, 93, 92.4, 93.6, 92.6, 90.8, 92.6, 92.4, 93.2, 90, 92.6, 91, 94.2, 90.2, 90.4)
...
cutoff_to_max = ceiling(cutoffs[8]):100
dist_to_max = length(cutoff_to_max)
polygon( c( cutoffs[8],cutoff_to_max, rev( c(cutoffs[8],cutoff_to_max)) ) , y=c(rep(0,(dist_to_max+1)), rev(pct_by_score)[1:(dist_to_max+1)]), col="#539c57",border=FALSE )
