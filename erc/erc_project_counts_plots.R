...
ga_colors = c( colorRampPalette(c("#8e0152","#ffffbf"))(16), colorRampPalette(c("#ffffbf","#313695"))(16) )
plot(1:32,1:32,cex=5,pch=16,type="p",col=ga_colors)
...
text(-5,34,"0", cex=2)
text(-5+length(ga_colors)/2-1,34, length(ga_colors) , cex=2)
